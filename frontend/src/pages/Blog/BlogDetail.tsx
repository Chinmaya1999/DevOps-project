  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {/* Blog Header */}
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden mb-8">
          {blog.coverImage && (
              ...
              {isAuthor && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-blue-500/20 border border-blue-500/50 rounded-lg text-blue-300 hover:bg-blue-500/30 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-red-500/20 border border-red-500/50 rounded-lg text-red-300 hover:bg-red-500/30 transition-colors"
                  >
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-8">
          <h2 className="text-2xl font-bold text-white mb-6">Comments ({blog.commentCount})</h2>
          ...
          {user ? (
            ...
            <div className="mb-8 p-4 bg-white/5 rounded-lg text-center">
              <p className="text-gray-300 mb-2">Please login to leave a comment</p>
          ...
          <div className="space-y-6">
            {blog.comments.length === 0 ? (
              ...
              blog.comments.map((comment) => (
                <div key={comment._id} className="border-b border-white/10 pb-6 last:border-0">
